...
from secistsploit.core.exploit.Banner import *
...
class secistsploitInterpreter(BaseInterpreter):
    ...
    def __init__(self):
        ...
        self.global_commands = sorted(["use ", "exec ", "help", "exit", "show ", "search ","banner "])
...
""".format(exploits_count=self.modules_count["exploits"],
           ...
           auxiliary_count=self.modules_count["auxiliary"],
           crack_count=self.modules_count["crack"],)
